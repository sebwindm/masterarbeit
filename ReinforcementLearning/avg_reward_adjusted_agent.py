...
# def rename_csv_metrics_per_episode(suffix):
#     """
#     Renames the csv file generated by the Gym environment and adds the name of the used algorithm/agent
#     """
#     os.rename("../Evaluation/results.csv", "../Evaluation/" + str(number_of_machines)
#               + "_" + str(suffix) + ".csv")
#     return


def train_DQN(number_of_machines, csv_metrics_per_episode, csv_rewards_per_period):
    """
...
def evaluate_with_DQN(number_of_machines, csv_metrics_per_episode, csv_rewards_per_period):
    """
    Not documented yet
    """
    from Algorithm.average_reward_adjusted_algorithm import DQNAverageRewardAdjusted  # ignore the error message in PyCharm
...
def train_a2c(number_of_machines, csv_metrics_per_episode, csv_rewards_per_period):
    """
      # not documented yet
    """
...
def train_ppo(number_of_machines, csv_metrics_per_episode, csv_rewards_per_period):
    """
      # not documented yet
    """
